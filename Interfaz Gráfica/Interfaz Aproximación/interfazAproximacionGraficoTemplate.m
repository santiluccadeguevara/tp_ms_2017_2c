...
% --- Executes just before interfazAproximacionGraficoTemplate is made visible.
function interfazAproximacionGraficoTemplate_OpeningFcn(hObject, eventdata, handles, varargin)
...
% UIWAIT makes interfazAproximacionGraficoTemplate wait for user response (see UIRESUME)
